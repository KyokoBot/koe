package moe.kyokobot.koe.experimental.media;
...
/**
 * Base interface for video frame providers.
 */
public interface VideoFrameProvider {
     ...
     *       instance attached to a connection (e.g. when set via {@code setVideoSender}).</li>
     *   <li>It is called again whenever the codec is changed via {@code setVideoCodec}
    ...
    /**
     * Called when this {@link VideoFrameProvider} should clean up it's event handlers and etc.
     */
    void dispose();
